...
if [ -f /var/run/apache2/apache2.pid ]; then
    ...
    echo -e "Found file 'apache2.pid' with pid $apachePid and procces name $proccesName.\n Let's check if there is a process belonging to it!"
    ...
    echo "Exiting from start script..."
    exit 0
fi
